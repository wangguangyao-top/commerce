...
class IndexController extends Controller
{
    public function index()
    {
        ...
        //猜你喜欢
        $goods = GoodsModel::select('goods_img', 'goods_id', 'goods_price','goods_name')->orderBy('add_time', 'desc')->limit('6')->where('is_del', 1)->get()->toArray();
        $goods=$this->goods($goods);
        return view('index/index', ['info' => $class, 'goods_img' => $goods_img, 'goods' => $goods]);
    }
