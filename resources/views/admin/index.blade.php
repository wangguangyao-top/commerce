...
<head>
    ...
    <link rel="stylesheet" href="../admin/plugins/bootstrap/admin/css/bootstrap.min.css">
    <link rel="stylesheet" href="../admin/plugins/adminLTE/admin/css/AdminLTE.css">
    <link rel="stylesheet" href="../admin/plugins/adminLTE/admin/css/skins/_all-skins.min.css">
    <link rel="stylesheet" href="../admin/css/style.css">
    
    <script src="../admin/plugins/jQuery/jquery-2.2.3.min.js"></script>
    <script src="../admin/plugins/jQueryUI/jquery-ui.min.js"></script>
    <script src="../admin/plugins/bootstrap/admin/js/bootstrap.min.js"></script>
  
    <script src="../admin/plugins/adminLTE/admin/js/app.min.js"></script>
