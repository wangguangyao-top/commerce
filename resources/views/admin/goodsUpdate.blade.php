                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="home">
                        <div class="row data-type">
                            ...
                            <div class="col-md-10 data rowHeight2x">
                                <input type="text" class="form-control" id="goods_score" value="{{$updateShow->goods_score}}" placeholder="购买积分奖励">
    ...
    <script>
        $(function (){
            $(document).on('blur','#goods_name',function (){
                ...
                var goods_id={{$updateShow->goods_id}};
                var data={goods_id:goods_id,goods_name:goods_name};
                var url='/admin/goodsVerify2';
                $.ajax({
                    type:'post',
                    url:url,
                    data:data,
